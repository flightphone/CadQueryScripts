...
def vase2():
    ...
    x_krita = [537.5, 400, 300, 225, 150, 75]
    y_krita = [387.5, 462.5, 462.5, 400, 387.5, 425]
    y0 = 312.5
    ...
    path1 = cq.Workplane("XY").parametricCurve(helix1,  start=0., stop = h)
    line1 = Curve3D(helix1, path1, r1, 0)

    path2 = cq.Workplane("XY").parametricCurve(helix2,  start=0., stop = h)
