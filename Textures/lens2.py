...
def render1():
    ...
    img.save("./stl/lens2.png")

    filter_mask = (maximum_filter(res_mask, size=block_size) > 0).astype(np.uint8) * 255
    img2 = Image.fromarray(filter_mask, mode='L')
    img2.save("./stl/lens2_mask.png")
